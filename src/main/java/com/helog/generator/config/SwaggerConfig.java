...
public class SwaggerConfig {
    ...
    public Docket defaultApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("默认接口")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.helog.generator.web"))
    ...
    private ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("http://www.helog.cn/")
                .contact(new Contact("helog","","heliang@beadwallet.com"))
                .version("1.0")
                .build();
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("swagger-bootstrap RESTful APIs")
                .description("swagger-bootstrap RESTful APIs")
                .termsOfServiceUrl("http://www.helog.cn/")
                .contact(new Contact("helog","","heliang@beadwallet.com"))
                .version("1.0")
