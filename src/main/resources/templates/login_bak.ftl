<html><head lang="en">
    ...
    <link  rel="stylesheet" type="text/css" href="http://amazeui.org/css/amazeui.min.css">
    <style>
        .header {
            text-align: center;
        }
...
<div class="header">
    <div class="am-g">
        <h1>Mybatisplus-Generator</h1>
        <p><b>因为有你，所以高效</b><br>让每个开发人员更多的关注业务代码</p>
    </div>
    <hr>
</div>
<div class="am-g">
