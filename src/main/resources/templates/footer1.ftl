...
<a href="#" class="am-icon-btn am-icon-th-list am-show-sm-only admin-menu" data-am-offcanvas="{target: '#admin-offcanvas'}">1111111111111</a>
...
<div>12222222222222222222222222222222</div>
</body>
</html>